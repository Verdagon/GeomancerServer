...
//           domino.AddInlineString(visibleOverlayPanelView, new Vec4i(255, 255, 255, 255), lines[i]);
//         }
//       } else {
//         domino.AddInlineString(visibleOverlayPanelView, new Vec4i(255, 255, 255, 255), message);
//         domino.AddInlineString(visibleOverlayPanelView, new Vec4i(255, 255, 255, 255), status);
